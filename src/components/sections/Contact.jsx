...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        'service_dc7pqtu', // Replace with your EmailJS Service ID
        'template_tnbktu4', // Replace with your EmailJS Template ID
        e.target, 
        'Y3yRpM32D7_IIfRRP' // Replace with your EmailJS Public Key
      )
      .then(
        (response) => {
