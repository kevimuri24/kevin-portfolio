        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-4rem)]">
          ...
          <div className="space-y-8 text-center lg:text-left">
            <div className="space-y-2">
              <p className="inline-flex items-center text-lg font-medium text-cyan-300 bg-cyan-50 px-4 py-2 rounded-full">
          ...
          <div className="relative">
            ...
            {/* Decorative elements */}
            <div className="absolute top-4 -left-4 w-24 h-24 bg-cyan-200 rounded-full blur-xl opacity-60" />
